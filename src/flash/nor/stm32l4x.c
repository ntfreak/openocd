...
static const uint32_t stm32l5_ns_flash_regs[STM32_FLASH_REG_NUM] = {
	[STM32_FLASH_ACR] = STM32L5_FLASH_ACR,
	[STM32_FLASH_KEYR] = STM32L5_FLASH_NSKEYR,
	[STM32_FLASH_OPTKEYR] = STM32L5_FLASH_OPTKEYR,
	[STM32_FLASH_SR] STM32L5_FLASH_NSSR,
	[STM32_FLASH_CR] = STM32L5_FLASH_NSCR,
	[STM32_FLASH_OPTR] = STM32L5_FLASH_OPTR,
	[STM32_FLASH_WRP1AR] = STM32L5_FLASH_WRP1AR,
	[STM32_FLASH_WRP1BR] = STM32L5_FLASH_WRP1BR,
	[STM32_FLASH_WRP2AR] = STM32L5_FLASH_WRP2AR,
	[STM32_FLASH_WRP2BR] = STM32L5_FLASH_WRP2BR,
};
