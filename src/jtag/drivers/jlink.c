...
static int jlink_init(void)
{
	...
	ret = jaylink_discovery_scan(jayctx, JAYLINK_HIF_USB);

	int ret1 = JAYLINK_ERR;
	if (use_serial_number)
		ret1 = jaylink_discovery_scan(jayctx, JAYLINK_HIF_TCP);

	if (ret != JAYLINK_OK && ret1 != JAYLINK_OK) {
