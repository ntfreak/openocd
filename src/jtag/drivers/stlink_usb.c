...
{
	int usb_retval;
	char desc_serial[255]; /* Max size of string descriptor */
	...
	if (jtag_libusb_error(usb_retval) != ERROR_OK) {
		LOG_ERROR("libusb_get_string_descriptor() returned %d", usb_retval);
		return NULL;
	}
