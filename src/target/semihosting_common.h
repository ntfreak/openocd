...
enum semihosting_tcp_config {
	SEMIHOSTING_TCP_CFG_NONE,
	SEMIHOSTING_TCP_CFG_DEBUG,
	SEMIHOSTING_TCP_CFG_ALL,
};
...
struct semihosting {
	...
	/** TCP configuration, NONE by default */
	enum semihosting_tcp_config tcp_config;
